...
function updateSkills(){
    ...
    rows.forEach(row => {
        ...
        const attrText = row.querySelector(".skill-attr").innerText;
        ...
        if(attrText.includes("FOR")){
            ...
            atributoValor = agilidade;

        }

        else if(attrText.includes("INT")){

            atributoValor = intelecto;
            ...
            atributoValor = presenca;

        }

        const total = atributoValor + treino + bonus;

        row.querySelector(".skill-total").innerText = total;
